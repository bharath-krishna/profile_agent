"""Shared configuration and utilities for FamilyMan sub-agents."""
...
class SubAgentConfig(BaseModel):
    ...
    model: str = Field(default_factory=lambda: os.getenv("MODEL_NAME", "gemini-2.5-flash"))
    use_litellm: bool = Field(default_factory=lambda: os.getenv("USE_LITELLM", "false").lower() == "true")


def get_profile_context() -> str:
    """Returns Bharath's complete professional profile context.

    This profile is injected into sub-agent instructions to provide context
    about Bharath's background, experience, and skills.
    """
...
### 1. Senior Software Engineer – Rakuten USA, California (May 2022 – Feb 2026)
