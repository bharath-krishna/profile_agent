...
def build_pdf(output_path):
    ...
    story.append(Paragraph('<font color="#888888">Employee ID:&nbsp;</font><font color="#555555"><b>100013657</b></font>', style_emp_id))
    story.append(Spacer(1, 6))
    ...
    experiences = [
        ("Senior Software Engineer", "Rakuten USA", "May 2022 \u2013 Present", [
